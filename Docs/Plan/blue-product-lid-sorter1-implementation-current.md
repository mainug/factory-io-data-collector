...
9. Coil 6·7 OFF
10. Blue Lid Belt 1 횡단을 위해 Coil 9를 8.5초 추가 유지
11. Coil 9 OFF
12. 제품 추적 상태 초기화
...
- Coil 6·7 OFF 후 Coil 9 추가 유지: `8.5초`
...
초기 `0.75초` 후행 설정으로는 제품이 Blue Lid Belt 1 중간에서 멈췄다. 다음 제품의 Blue Lid Camera 신호로 Coil 9가 다시 ON될 때 이전 제품이 추가 이동하는 현상을 통해, 제품 1개가 벨트를 완전히 횡단하려면 약 15초의 전체 Coil 9 구동시간이 필요함을 확인했다.

Coil 6·7 OFF 후 Coil 9 후행 설정을 `8.5초`로 변경한 최종 단일 제품 시험 결과는 다음과 같다.

```text
14:02:29.224  Blue Lid Camera ON
14:02:29.235  Coil 9 ON
14:02:33.480  Read Sensor Sorter 1 ON
14:02:33.484  Coil 6 ON
14:02:34.236  Read Sensor Sorter 1 OFF
14:02:36.250  Coil 6 OFF
14:02:36.253  Coil 7 OFF
14:02:44.831  Coil 9 OFF
```

- Coil 6·7 OFF 후 Coil 9의 실제 후행 구동시간은 약 `8.58초`였다.
- 제품이 Blue Lid Belt 1 끝까지 이동하여 다음 구간에 정상 도달했다.
- 자동 분류 중지 후 Coil 5~9가 모두 OFF됐다.
- Coil 9 후행 설정값 `8.5초`를 현재 확정 후보값으로 유지한다.
...
- [x] Coil 9 후행시간 부족으로 Blue Lid Belt 1 중간 정지 현상 확인
- [x] Coil 9 후행 설정을 `8.5초`로 보정
- [x] 제품 1개 Blue Lid Belt 1 완전 횡단 및 다음 구간 도달 확인
...
- [ ] 반복 시험으로 Sorter 배출 유지시간과 Coil 9 `8.5초` 설정 안정성 확인
